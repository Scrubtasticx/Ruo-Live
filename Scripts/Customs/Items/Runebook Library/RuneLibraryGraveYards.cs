...
{
	public class RuneLibraryGraveYards : Item
	{
      ...
      {
         CommandSystem.Register( "RuneLibraryGraveYards", AccessLevel.Administrator, new CommandEventHandler( RuneLibraryGraveYards_OnCommand ) );
      }

		public static void RuneLibraryGraveYards_OnCommand( CommandEventArgs args )
		{
			Mobile m = args.Mobile;
         	RuneLibraryGraveYards rl = new RuneLibraryGraveYards(m);
		}
		...
		[Constructable]
		public RuneLibraryGraveYards (Mobile from)
		{
			...
			for( int i=0; i<size; i++ )
			{
				...
				{
					rb.Name = "GraveYards " + nameStart + " - " + (nameEnd-1);
					library.Add(rb);
					rb = new Runebook(0);
					nameStart = nameEnd;
				}
		...
		public RuneLibraryGraveYards( Serial serial ) : base( serial )
		{
		}
