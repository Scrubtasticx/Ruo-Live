...
{
	public class RuneLibraryDungeons : Item
	{
      ...
      {
         CommandSystem.Register( "RuneLibraryDungeons", AccessLevel.Administrator, new CommandEventHandler( RuneLibraryDungeons_OnCommand ) );
      }

		public static void RuneLibraryDungeons_OnCommand( CommandEventArgs args )
		{
			Mobile m = args.Mobile;
         	RuneLibraryDungeons rl = new RuneLibraryDungeons(m);
		}
		...
		public RuneLibraryDungeons( Serial serial ) : base( serial )
		{
		}
