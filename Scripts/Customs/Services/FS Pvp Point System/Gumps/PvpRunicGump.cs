...
{
	public class PvpRunicGump : Gump
	{
		private string m_GumpTitle = "Runic Menu (All Runics Are Valortie)";
		private string m_Item1 = "Runic Hammer";
		private string m_Item2 = "Runic Sewing Kit";
		private string m_Item3 = "Runic Fletchers Tools";
		private string m_Item4 = "Runic Tinkers Tools";
		private string m_Item5 = "Runic Saw";
		private int m_Cost1 = 300;
		private int m_Cost2 = 300;
		private int m_Cost3 = 300;
		private int m_Cost4 = 300;
		private int m_Cost5 = 300;

		public PvpRunicGump() : base( 25, 25 )
		{
			Closable=true;
			Disposable=true;
			Dragable=true;
			...
			if ( from == null )
				...
				if ( pm.TotalPoints >= m_Cost1 )
				{
					...
					from.AddToBackpack( new RunicHammer( CraftResource.Valorite, 50 ) );
				}
				else
				{
				...
				if ( pm.TotalPoints >= m_Cost2 )
				{
					...
					from.SendMessage( "You buy the item." );
					from.AddToBackpack( new RunicSewingKit( CraftResource.Valorite, 50 ) );
				}
				else
				{
					from.SendMessage( "You lack the pvp points to buy this item." );
				...
				if ( pm.TotalPoints >= m_Cost3 )
				{
					...
					from.SendMessage( "You buy the item." );
					from.AddToBackpack( new RunicFletcherTools( CraftResource.Valorite, 50 ) );
				}
				else
				{
					from.SendMessage( "You lack the pvp points to buy this item." );
				...
				if ( pm.TotalPoints >= m_Cost4 )
				{
					...
					from.SendMessage( "You buy the item." );
					from.AddToBackpack( new RunicTinkerTools( CraftResource.Valorite, 50 ) );
				}
				else
				{
					from.SendMessage( "You lack the pvp points to buy this item." );
				...
				if ( pm.TotalPoints >= m_Cost5 )
				{
					...
					from.SendMessage( "You buy the item." );
					from.AddToBackpack( new RunicSaw( CraftResource.Valorite, 50 ) );
				}
				else
				{
					from.SendMessage( "You lack the pvp points to buy this item." );
