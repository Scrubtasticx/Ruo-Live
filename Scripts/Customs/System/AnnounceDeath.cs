            ...
            if (args.Mobile.AccessLevel < AccessLevel.GameMaster)
            {
                switch (Utility.Random(4))
                {
                    case 0:
                        ...
                        World.Broadcast(0x40, false, "Death to {0} May God have mercy on your soul.", args.Mobile.Name);
                        break;
                    ...
                    case 2:
                        args.Mobile.PlaySound(256);
                        World.Broadcast(0x31, false, "Death Comes for Us all, But on this Day, For {0}.", args.Mobile.Name);
                        break;

                    case 3:
                        args.Mobile.PlaySound(256);
                        World.Broadcast(0x40, false, "{0} Has Succumbed To Their Wounds And Has Perished!", args.Mobile.Name);
                        break;
