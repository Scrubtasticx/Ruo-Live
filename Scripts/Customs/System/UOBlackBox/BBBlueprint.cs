...
namespace Server.UOBlackBox
{
    ...
    public class BBBlueprint : Item
    {
        ...
        public override void OnDoubleClick(Mobile from)
        {
            ...
            if (PM != null)
            {
               if (File.Exists(@"C:\Users\scrub\Downloads\BlackBox\SAVE\Builds\Blueprints\Admin\" + fileName))
                {
                    if (!IsChildOf(PM.Backpack))
                    {
                       LoadFromBlueprints(PM, @"C:\Users\scrub\Downloads\BlackBox\SAVE\Builds\Blueprints\Admin\" + fileName, X, Y, Z, Map, Name);
                    }
                    else
                    {
                       LoadFromBlueprints(PM, @"C:\Users\scrub\Downloads\BlackBox\SAVE\Builds\Blueprints\Admin\" + fileName, PM.X, PM.Y, PM.Z, PM.Map, Name);
                    }
                }
            }
        }
